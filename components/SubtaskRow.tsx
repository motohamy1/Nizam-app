    ...
    return (
      <View style={[{ backgroundColor: cardBg, borderRadius: 12, padding: 12, gap: 10, borderWidth: 1, borderColor: isBrightBg ? colors.text + '20' : colors.border + '40', marginBottom: 8 }]}>
        ...
        <View style={[{ flexDirection: 'row', alignItems: 'center', gap: 10 }]}>
          ...
          <TextInput
            style={[{ flex: 1, color: contentColor, fontSize: 16, backgroundColor: isBrightBg ? colors.text + '08' : colors.bg, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: isBrightBg ? colors.text + '40' : modeColor('#e5f19d', isDarkMode), fontWeight: '600' }, isArabic && { textAlign: 'right' }]}
            value={editText}
        ...
        <View style={[{ flexDirection: 'row', gap: 10 }]}>
           <TouchableOpacity
            style={{ flex: 1, backgroundColor: sub.status === 'in_progress' ? colors.warning : modeColor('#e5f19d', isDarkMode), paddingVertical: 10, borderRadius: 10, alignItems: 'center' }}
      ...
      <View style={[{ flexDirection: 'row', alignItems: 'center', padding: 12 }]}>
        ...
        <View style={[{ flexDirection: 'row', alignItems: 'center', gap: 6, marginStart: 8 }]}>
          ...
          <TouchableOpacity onPress={() => (setIsEditing(true), setEditText(sub.text))} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>
            <Ionicons name="create-outline" size={19} color={isBrightBg ? colors.text : modeColor('#e5f19d', isDarkMode)} />
          </TouchableOpacity>
